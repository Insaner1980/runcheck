...
class HealthScoreCalculatorTest {
    ...
    fun `wifi with good download speed and recent speed test yields high network score`() {
        val score = calculator.calculate(
            ...
            healthyThermal(),
            healthyStorage(),
            recentSpeedTest = recentSpeedTest(
                downloadMbps = 80.0,
                pingMs = 15,
                jitterMs = 2
            )
    ...
    fun `high jitter in speed test reduces network score`() {
        val lowJitterScore = calculator.calculate(
            healthyBattery(),
            healthyNetwork(),
            healthyThermal(),
            healthyStorage(),
        ...
        val highJitterScore = calculator.calculate(
            healthyBattery(),
            healthyNetwork(),
            healthyThermal(),
            healthyStorage(),
    ...
    fun `stale speed test is ignored and basic scoring is used`() {
        val staleSpeedTest = SpeedTestResult(
            id = 1,
        ...
        val scoreWithStale = calculator.calculate(
            healthyBattery(),
            healthyNetwork(),
            healthyThermal(),
            healthyStorage(),
        ...
        val scoreWithout = calculator.calculate(
            healthyBattery(),
            healthyNetwork(),
            healthyThermal(),
            healthyStorage(),
    ...
    fun `null jitter in speed test defaults to 80 stability score`() {
        ...
        val nullJitterScore = calculator.calculate(
            healthyBattery(),
            healthyNetwork(),
            healthyThermal(),
            healthyStorage(),
    ...
    fun `low voltage 3200mV causes significant battery deduction`() {
        val lowVoltageScore = calculator.calculate(
            healthyBattery().copy(voltageMv = 3200),
            healthyNetwork(),
            healthyThermal(),
            healthyStorage()
        )
        val idealVoltageScore = calculator.calculate(
    ...
    fun `mid voltage 3600mV has no voltage deduction`() {
        ...
        val idealScore = calculator.calculate(
            healthyBattery().copy(voltageMv = 4000),
            healthyNetwork(),
            healthyThermal(),
            healthyStorage()
