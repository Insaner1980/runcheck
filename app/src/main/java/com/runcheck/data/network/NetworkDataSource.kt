...
class NetworkDataSource @Inject constructor(
    ...
    private fun buildNetworkInfo(
        ...
        val signalQuality = classifySignal(signalDbm, connectionType, cachedNetworkTypeName)
    ...
    private fun classifySignal(
        ...
        return when (type) {
            ...
            ConnectionType.CELLULAR -> classifyCellularSignal(dbm, networkSubtype)
    ...
    private fun classifyCellularSignal(dbm: Int, networkSubtype: String?): SignalQuality {
