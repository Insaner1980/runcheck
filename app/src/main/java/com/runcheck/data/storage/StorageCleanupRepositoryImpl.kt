...
@Singleton
class StorageCleanupRepositoryImpl @Inject constructor(
    private val mediaStoreScanner: MediaStoreScanner,
    private val storageCleanupHelper: StorageCleanupHelper
) : StorageCleanupRepository {

    override suspend fun getTrashedUris(): List<String> =
        mediaStoreScanner.getTrashedUris().map { it.toString() }
    ...
    override suspend fun getCleanupGroupUris(
        ...
        mediaStoreScanner.getCleanupGroupUris(query, category)
