...
sealed interface MediaDeleteRequestResult {
    data class Ready(val request: IntentSenderRequest) : MediaDeleteRequestResult
    data class Failed(@param:StringRes val messageRes: Int) : MediaDeleteRequestResult
}

fun buildMediaDeleteRequest(
    context: Context,
    uriStrings: List<String>
): MediaDeleteRequestResult = buildMediaDeleteRequestResult(
