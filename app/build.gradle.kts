...
val jacocoDebugUnitTestReportExclusions =
    listOf(
        ...
        "**/data/battery/*BatterySource*.*",
        "**/data/battery/BatteryDataSourceFactory*.*",
        "**/data/billing/BillingManager*.*",
        "**/data/billing/ProStatusCache*.*",
        "**/data/device/DeviceCapabilityManager*.*",
        "**/data/device/DeviceProfileProvider*.*",
        "**/data/device/DeviceProfileRepositoryImpl*.*",
        "**/data/export/FileExportRepositoryImpl*.*",
        "**/data/network/LatencyMeasurer*.*",
        "**/data/network/NetworkDataSource*.*",
        "**/data/preferences/MonitoringStatusRepositoryImpl*.*",
        "**/data/preferences/UserPreferencesRepositoryImpl*.*",
        ...
        "**/data/thermal/ThermalDataSource*.*",
        "**/service/monitor/*Service*.*",
        "**/service/monitor/*Worker*.*",
        "**/service/monitor/*Receiver*.*",
        "**/service/monitor/MonitoringAlertStateStore*.*",
        "**/service/monitor/NotificationHelper*.*",
        "**/service/monitor/ScreenStateTracker*.*",
        "**/ui/**/*Screen*.*",
        "**/ui/**/*Sections*.*",
        "**/ui/**/*Section*.*",
        "**/ui/**/*Card*.*",
        ...
        "**/ui/**/*Pill*.*",
        "**/ui/**/NavGraph*.*",
        "**/ui/chart/ChartAccessibility*.*",
        "**/ui/common/ChartSelection*.*",
        "**/ui/common/LifecycleStartStopEffect*.*",
        "**/ui/common/RememberSaveableEnum*.*",
        "**/ui/common/UiFormatters*.*",
        "**/ui/common/UiText*.*",
        "**/ui/components/**",
        "**/ui/home/HomeStatusTiles*.*",
        "**/ui/home/insights/InsightStringResolver*.*",
        "**/ui/storage/cleanup/CleanupBottomBar*.*",
        "**/ui/storage/cleanup/FileListItem*.*",
        "**/ui/storage/cleanup/CleanupThumbnailLoader*.*",
        "**/ui/theme/**",
        "**/util/Api29MediaDeleteConsent*.*",
        "**/util/MediaStoreDeleteRequests*.*",
        "**/util/ReleaseSafeLog*.*",
        "**/util/RuncheckPermissionPolicy*.*",
        "**/widget/**",
    )
