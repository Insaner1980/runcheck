...
|---|---|---|---|
| Home | `home` | `NavHost.startDestination`; sovelluksen launcher avaa `MainActivity`n, joka luo `RuncheckNavHost`in ([NavGraph.kt](../app/src/main/java/com/runcheck/ui/navigation/NavGraph.kt#L64), [MainActivity.kt](../app/src/main/java/com/runcheck/MainActivity.kt#L39)). | Juurikohde; `home` on direct-route. Ilmoitusreitti tyhjentaa stackin aloituskohteeseen ennen navigointia ([NavGraph.kt](../app/src/main/java/com/runcheck/ui/navigation/NavGraph.kt#L390)). |
